...
public class SentryLinkHandler {
    ...
    public static void onBlockRightClick(PlayerInteractEvent.RightClickBlock event) {
        ...
        if (!heldItem.is(AllItems.WRENCH.get()) && !heldItem.getItem().getDescriptionId().contains("wrench")) {
        ...
        if (firstSelectedPos == null) {
            ...
            if (validPair) {
                ...
                NetworkHandler.CHANNEL.sendToServer(new SentryLinkPacket(firstSelectedPos, pos));
    ...
    public static void onRenderLevel(RenderLevelStageEvent event) {
        ...
        boolean hasWrench = heldItem.is(AllItems.WRENCH.get()) || heldItem.getItem().getDescriptionId().contains("wrench");
        if (!hasWrench) {
